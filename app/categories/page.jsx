    ...
    <>
      ...
      <main className="min-h-screen pt-20 pb-[100px] bg-[#0a0a0f]">
        ...
        <div className="pt-8 md:pt-12 pb-6 md:pb-8 px-6 md:px-8 max-w-[1152px] mx-auto">
          <h1 className="text-3xl md:text-[2.5rem] font-extrabold text-white mb-2 md:mb-4 font-['Syne',sans-serif]">
            Categories
          </h1>
          <p className="text-gray-400 text-[0.95rem] md:text-base">
              ...
              {categories.map(cat => {
                ...
                return (
                  ...
                  >
                    ...
                    <span className={`text-[0.8rem] md:text-[0.9rem] font-semibold ${isActive ? 'text-[#f5c842]' : 'text-gray-400'}`}>{cat.name}</span>
                  </button>
                )
              })}
        ...
        {loading ? (
          <div className="text-center py-16 text-gray-500">Loading premium categories...</div>
        ) : (
          <div className="max-w-[1152px] mx-auto px-6 md:px-8">
            
            {/* POPULAR CATEGORIES SECTION */}
            <div className="mb-12 md:mb-16">
              <h2 className="text-xl md:text-2xl font-bold text-white mb-5 md:mb-8 font-['Syne',sans-serif]">
                Popular Categories
              </h2>
              <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4 md:gap-6 lg:gap-8">
                {displayPopular.map(cat => (
                  ...
                  >
                    <div className="card p-5 md:p-6 lg:p-8 h-full flex flex-col relative bg-white/5 border border-white/10 rounded-3xl md:rounded-[2rem] overflow-hidden transition-all duration-300 hover:-translate-y-2 hover:border-[#f5c842]/30 hover:shadow-[0_15px_40px_rgba(245,200,66,0.15)]">
                      ...
                      <h3 className="text-lg md:text-xl font-bold text-white mb-1.5 md:mb-3">{cat.name}</h3>
                      <p className="text-gray-400 text-xs md:text-sm leading-relaxed flex-1 mb-6 md:mb-8">
                        {cat.desc}
                      </p>
                      
                      <div className="flex items-center justify-between mt-auto">
                        <span className="bg-white/5 text-gray-300 text-[11px] md:text-xs py-1.5 px-3 rounded-full font-semibold border border-white/10">
              ...
              <div className="flex flex-col gap-3 md:gap-4 lg:grid lg:grid-cols-2 lg:gap-6">
                {displayAll.map(cat => (
                  <Link 
                    ...
                    className="no-underline group"
                  >
                    <div className="p-4 px-5 md:p-5 md:px-6 flex items-center gap-4 md:gap-6 bg-white/5 border border-white/10 rounded-2xl md:rounded-3xl transition-all duration-300 group-hover:bg-white/10 group-hover:border-white/20 group-hover:-translate-y-1 hover:shadow-[0_10px_30px_rgba(255,255,255,0.05)]">
                      ...
                      <div className="flex-1 min-w-0">
                        <h3 className="text-base md:text-lg font-semibold text-white mb-1 md:mb-1.5">{cat.name}</h3>
                        <p className="text-gray-400 text-xs md:text-sm whitespace-nowrap overflow-hidden text-ellipsis">
                          {cat.desc}
                        </p>
                      </div>

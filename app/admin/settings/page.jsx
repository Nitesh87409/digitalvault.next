        ...
        <div className="flex-1 min-w-0">
          {loading ? (
            ...
            <div className="flex flex-col gap-6">
              ...
              {/* BRANDING TAB */}
              {activeTab === 'branding' && (
                <div className="bg-[#1a1a2a] rounded-2xl p-5 sm:p-8 border border-white/10 shadow-lg animate-in fade-in slide-in-from-bottom-2 duration-300">
                  <h2 className="text-xl font-syne font-bold text-white mb-6">Branding & Website Settings</h2>
                  
                  <div className="grid grid-cols-1 gap-6 mb-8">
                    <div>
                      <label className="text-sm font-semibold text-gray-400 block mb-2 uppercase tracking-wider">Website Display Name</label>
                      <input
                        type="text"
                      ...
                      />
                      <p className="text-xs text-gray-500 mt-2">Leave blank to use the ENV variable (NEXT_PUBLIC_APP_NAME).</p>
                    </div>

                    <div>
                      <label className="text-sm font-semibold text-gray-400 block mb-2 uppercase tracking-wider">Website Logo</label>
                      <div className="flex items-center gap-4">
                        ...
                        <div>
                          <input
                            ...
                            className="text-sm text-gray-400 file:mr-4 file:py-2 file:px-4 file:rounded-full file:border-0 file:text-sm file:font-semibold file:bg-[#f5c842]/10 file:text-[#f5c842] hover:file:bg-[#f5c842]/20"
                          />
                          <p className="text-xs text-gray-500 mt-2">Upload a logo to display in the navbar and emails.</p>
                          {settings.app_logo && (
              ...
              {activeTab === 'contact' && (
                <div className="bg-[#1a1a2a] rounded-2xl p-5 sm:p-8 border border-white/10 shadow-lg animate-in fade-in slide-in-from-bottom-2 duration-300">
                  <h2 className="text-xl font-syne font-bold text-white mb-6">Contact & Support Settings</h2>
              ...
              {activeTab === 'login' && (
                <div className="flex flex-col gap-6 animate-in fade-in slide-in-from-bottom-2 duration-300">
                  <div className="bg-[#1a1a2a] rounded-2xl p-5 sm:p-8 border border-white/10 shadow-lg">
                    <h2 className="text-xl font-syne font-bold text-white mb-6">Login Methods</h2>
                  ...
                  <div className="bg-[#1a1a2a] rounded-2xl p-5 sm:p-8 border border-white/10 shadow-lg">
                    <h2 className="text-xl font-syne font-bold text-white mb-6">OTP Configuration</h2>
              ...
              {activeTab === 'social' && (
                <div className="bg-[#1a1a2a] rounded-2xl p-5 sm:p-8 border border-white/10 shadow-lg animate-in fade-in slide-in-from-bottom-2 duration-300">
                  <h2 className="text-xl font-syne font-bold text-white mb-6">Social Login Methods</h2>

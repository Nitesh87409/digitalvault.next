  ...
  return (
    <div className="font-sans bg-[#0a0a0f] min-h-screen text-[#e8e8f0] flex flex-col">
      ...
      <nav className="bg-[#0e0e18] border-b border-[#f5c842]/10 p-4 sm:px-6 flex items-center justify-between sticky top-0 z-10">
        ...
        <button onClick={() => openModal()} className="bg-gradient-to-br from-[#f5c842] to-[#e0a800] text-[#0a0a0f] font-syne font-bold border-none cursor-pointer px-4 py-2 rounded-lg text-sm shadow-lg shadow-[#f5c842]/20 hover:scale-[1.02] transition-transform">
          + Add Fake Review
        </button>
      </nav>

      <div className="w-full max-w-7xl mx-auto my-6 sm:my-10 px-4 sm:px-6 flex-1 flex flex-col">
        <h1 className="font-syne text-2xl sm:text-3xl font-bold text-white mb-6">Manage Reviews</h1>

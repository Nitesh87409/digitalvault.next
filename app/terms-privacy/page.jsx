...
export default function TermsPrivacyPage() {
  ...
  const termsContent = settings?.terms_privacy_content || '<h1>Terms & Privacy Policy</h1><p>Our terms of service and privacy policies are currently being updated. Please check back later or contact support.</p>';

...
function addSecurityHeaders(response) {
  ...
  response.headers.set(
    ...
    [
      "default-src 'self'",
      "script-src 'self' 'unsafe-inline' 'unsafe-eval' https://checkout.razorpay.com https://api.razorpay.com https://accounts.google.com",
...
export function proxy(request) {
  ...
  if (isCustomerRoute) {
    if (!isCustomer) {
      return addSecurityHeaders(NextResponse.redirect(new URL('/register', request.url)));
    }
  }

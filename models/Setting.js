...
const SettingSchema = new mongoose.Schema({
  ...
  about_us_content: {
    type: String,
    default: `<h1>About Us</h1><p>Welcome to our store! We are dedicated to providing the highest quality premium digital products, templates, and resources to help creators, developers, and modern entrepreneurs launch, grow, and scale their online presence.</p><h2>Our Mission</h2><p>Our goal is to make professional digital assets affordable, accessible, and extremely simple to implement. We select, refine, and bundle top-tier tools and assets so that you can bypass hours of design/development work and get straight to building your dreams.</p><h2>Why Choose Our Platform?</h2><ul><li><strong>Premium Quality:</strong> Every digital product is carefully curated, tested, and optimized for performance and design.</li><li><strong>Instant Digital Delivery:</strong> Get immediate access to your purchase right in your inbox and download dashboard.</li><li><strong>Money-Back Guarantee:</strong> We stand behind our quality with a 7-day guarantee for functional defects.</li><li><strong>Lifetime Free Updates:</strong> Once purchased, you receive all future updates for that product without paying extra.</li></ul><p>Thank you for trusting us to support your digital journey!</p>`
  },
